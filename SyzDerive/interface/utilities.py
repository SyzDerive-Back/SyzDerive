...
def save_cases_as_json(key, max_num):
    ...
    pwd = os.getcwd()
    spec = importlib.util.spec_from_file_location("syzbotCrawler", pwd+"/SyzDerive/modules/syzbotCrawler.py")
...
def duplicated_warning():
    p = '/xxx/results_of_syzbot_analysis/WARNING_LATEST/'
...
if __name__ == '__main__':
    ...
    base = '/home/xxx/projects/results_of_syzbot_analysis/GPF_BUG_FIXED_9-20-2021-Camera_ready'
    d = {}
